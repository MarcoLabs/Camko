...
namespace defaults
{
	inline constexpr std::string_view kDefaultConfigToml =
R"toml([project]
name = "main"
version = "0.1.0"
...
header-directory = "include"
	...
	inline constexpr std::string_view kDefaultMainCpp =
...
int main()
{
	...
	inline constexpr std::string_view kDefaultGitIgnore =
R"cpp(.camko/)cpp";

	inline constexpr std::string_view kDefaultHelpMessage = R"(
camko 0.1.0
